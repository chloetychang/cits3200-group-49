...
class ViewGeneticSourceWidget extends StatefulWidget {
  const ViewGeneticSourceWidget({super.key});

  static String routeName = 'ViewGeneticSource';
  static String routePath = '/viewGeneticSource';

  @override
  State<ViewGeneticSourceWidget> createState() =>
      _ViewGeneticSourceWidgetState();
}

class _ViewGeneticSourceWidgetState extends State<ViewGeneticSourceWidget> {
  late ViewGeneticSourceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewGeneticSourceModel());
  }
