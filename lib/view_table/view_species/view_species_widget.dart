...
import 'view_species_model.dart';
export 'view_species_model.dart';

class ViewSpeciesWidget extends StatefulWidget {
  const ViewSpeciesWidget({super.key});

  static String routeName = 'ViewSpecies';
  static String routePath = '/viewSpecies';

  @override
  State<ViewSpeciesWidget> createState() => _ViewSpeciesWidgetState();
}

class _ViewSpeciesWidgetState extends State<ViewSpeciesWidget> {
  late ViewSpeciesModel _model;
