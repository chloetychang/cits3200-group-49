...
import 'v_users_model.dart';
export 'v_users_model.dart';

class VUsersWidget extends StatefulWidget {
  const VUsersWidget({super.key});

  static String routeName = 'V_Users';
  static String routePath = '/vUsers';

  @override
  State<VUsersWidget> createState() => _VUsersWidgetState();
}

class _VUsersWidgetState extends State<VUsersWidget> {
  late VUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VUsersModel());
  }
