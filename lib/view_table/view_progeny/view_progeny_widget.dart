...
import 'view_progeny_model.dart';
export 'view_progeny_model.dart';

class ViewProgenyWidget extends StatefulWidget {
  const ViewProgenyWidget({super.key});

  static String routeName = 'ViewProgeny';
  static String routePath = '/viewProgeny';

  @override
  State<ViewProgenyWidget> createState() => _ViewProgenyWidgetState();
}

class _ViewProgenyWidgetState extends State<ViewProgenyWidget> {
  late ViewProgenyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewProgenyModel());
  }
                          ...
                          children: [
                            Expanded(
                              child: FutureBuilder<List<dynamic>>(
                                future: ApiService.getView_Progeny(),
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDataTable<dynamic>(
                                    ...
                                    columnsBuilder: (onSortChanged) => [
                                      const DataColumn2(label: Text('Family name')),
                                      const DataColumn2(label: Text('Child name')),
                                      const DataColumn2(label: Text('Comments')),
                                    ],
                                    dataRowBuilder: (item, index, selected, onSelectChanged) => DataRow(
                                      ...
                                      cells: [
                                        DataCell(Text(item['family_name'] ?? '')),
                                        DataCell(Text(item['child_name'] ?? '')),
