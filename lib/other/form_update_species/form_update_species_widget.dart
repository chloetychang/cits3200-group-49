...
export 'form_update_species_model.dart';

class FormUpdateSpeciesWidget extends StatefulWidget {
  const FormUpdateSpeciesWidget({
    super.key,
    int? placeholder,
  ...
  static String routeName = 'FormUpdateSpecies';
  static String routePath = '/formUpdateSpecies';

  @override
  State<FormUpdateSpeciesWidget> createState() =>
      _FormUpdateSpeciesWidgetState();
}

class _FormUpdateSpeciesWidgetState extends State<FormUpdateSpeciesWidget> {
  late FormUpdateSpeciesModel _model;
