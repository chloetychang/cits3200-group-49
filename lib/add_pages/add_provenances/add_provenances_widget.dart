...
class AddProvenancesWidget extends StatefulWidget {
  ...
  static String routeName = 'AddProvenances';
  static String routePath = '/addProvenances';

  @override
  State<AddProvenancesWidget> createState() => _AddProvenancesWidgetState();
}

class _AddProvenancesWidgetState extends State<AddProvenancesWidget> {
  late AddProvenancesModel _model;
