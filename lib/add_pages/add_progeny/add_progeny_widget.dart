...
class AddProgenyWidget extends StatefulWidget {
  ...
  static String routeName = 'AddProgeny';
  static String routePath = '/addProgeny';

  @override
  State<AddProgenyWidget> createState() => _AddProgenyWidgetState();
}

class _AddProgenyWidgetState extends State<AddProgenyWidget> {
  late AddProgenyModel _model;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(UpdateProgenyWidget.routeName);
                          },
                          text: 'Update',
                          options: FFButtonOptions(
                            width: 100.0,
