...
import 'add_zone_model.dart';
export 'add_zone_model.dart';
...
class AddZoneWidget extends StatefulWidget {
  ...
  static String routeName = 'AddZone';
  static String routePath = '/addZone';
...
class _AddZoneWidgetState extends State<AddZoneWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddZoneModel());
  }
                        ...
                        children: [
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed(UpdateZoneWidget.routeName);
                              },
                              text: 'Update',
