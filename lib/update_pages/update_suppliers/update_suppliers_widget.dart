...
import 'update_suppliers_model.dart';
export 'update_suppliers_model.dart';

class UpdateSuppliersWidget extends StatefulWidget {
  const UpdateSuppliersWidget({
    super.key,
    int? placeholder,
  ...
  static String routeName = 'UpdateSuppliers';
  static String routePath = '/updateSuppliers';

  @override
  State<UpdateSuppliersWidget> createState() => _UpdateSuppliersWidgetState();
}

class _UpdateSuppliersWidgetState extends State<UpdateSuppliersWidget> {
  late UpdateSuppliersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateSuppliersModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(AddSuppliersWidget.routeName);
                          },
                          text: 'Add',
                          options: FFButtonOptions(
                            width: 100.0,
