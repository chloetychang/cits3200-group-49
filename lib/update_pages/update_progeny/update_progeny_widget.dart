...
import 'update_progeny_model.dart';
export 'update_progeny_model.dart';

class UpdateProgenyWidget extends StatefulWidget {
  const UpdateProgenyWidget({
    super.key,
    int? placeholder,
  ...
  static String routeName = 'UpdateProgeny';
  static String routePath = '/updateProgeny';

  @override
  State<UpdateProgenyWidget> createState() => _UpdateProgenyWidgetState();
}

class _UpdateProgenyWidgetState extends State<UpdateProgenyWidget> {
  late UpdateProgenyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateProgenyModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(AddProgenyWidget.routeName);
                          },
                          text: 'Add',
