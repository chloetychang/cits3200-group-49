...
import 'update_acquisitions_model.dart';
export 'update_acquisitions_model.dart';

class UpdateAcquisitionsWidget extends StatefulWidget {
  const UpdateAcquisitionsWidget({
    super.key,
    int? placeholder,
  ...
  static String routeName = 'UpdateAcquisitions';
  static String routePath = '/updateAcquisitions';

  @override
  State<UpdateAcquisitionsWidget> createState() =>
      _UpdateAcquisitionsWidgetState();
}

class _UpdateAcquisitionsWidgetState extends State<UpdateAcquisitionsWidget> {
  late UpdateAcquisitionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateAcquisitionsModel());
