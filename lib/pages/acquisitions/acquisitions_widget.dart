...
import 'acquisitions_model.dart';
export 'acquisitions_model.dart';

class AcquisitionsWidget extends StatefulWidget {
  const AcquisitionsWidget({super.key});

  static String routeName = 'Acquisitions';
  static String routePath = '/acquisitions';

  @override
  State<AcquisitionsWidget> createState() => _AcquisitionsWidgetState();
}

class _AcquisitionsWidgetState extends State<AcquisitionsWidget>
    with TickerProviderStateMixin {
  late AcquisitionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcquisitionsModel());
              ...
              children: [
                Row(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(39.0, 12.0, 0.0, 8.0),
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            functions.tabTitle(_model.tabBarCurrentIndex),
                            'Acquisitions',
                          ),
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 39.0, 0.0),
                      child: Text(
                        ...
                        child: FlutterFlowButtonTabBar(
                          ...
                          onTap: (i) async {
                            [
                              ...
                              () async {
                                context.pushNamed(
                                  ResearchFamilyWidget.routeName,
                                  extra: <String, dynamic>{
                                    kTransitionInfoKey: TransitionInfo(
                                      hasTransition: true,
                                      transitionType: PageTransitionType.fade,
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 39.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
